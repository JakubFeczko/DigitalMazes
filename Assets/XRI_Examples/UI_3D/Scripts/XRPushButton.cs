...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class XRPushButton : XRBaseInteractable
    {
        ...
        [SerializeField]
        [Tooltip("The first Light Point that will be toggled")]
        private Light m_LightPoint1;

        [SerializeField]
        [Tooltip("The second Light Point that will be toggled")]
        private Light m_LightPoint2;
        ...
        protected override void OnEnable()
        {
            ...
            m_OnPress.AddListener(() =>
            {
                if (m_LightPoint1 != null) m_LightPoint1.enabled = !m_LightPoint1.enabled; // Toggle Light Point 2 on/off when the button is pressed
                if (m_LightPoint2 != null) m_LightPoint2.enabled = !m_LightPoint2.enabled; // Toggle Light Point 2 on/off when the button is pressed
            });
        ...
        protected override void OnDisable()
        {
            ...
            m_OnRelease.RemoveAllListeners();
